...
export const AddressBook = {
  ...
  create<I extends Exact<DeepPartial<AddressBook>, I>>(base?: I): AddressBook {
    return AddressBook.fromPartial(base ?? {});
  },
...
export const AddressRequest = {
  ...
  create<I extends Exact<DeepPartial<AddressRequest>, I>>(base?: I): AddressRequest {
    return AddressRequest.fromPartial(base ?? {});
  },
...
export const AddressService = {
  getAllAddresses: {
    path: "/address.Address/GetAllAddresses",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value: Buffer) => Empty.decode(value),
    responseSerialize: (value: AddressBook) => Buffer.from(AddressBook.encode(value).finish()),
    responseDeserialize: (value: Buffer) => AddressBook.decode(value),
  },
  getAddress: {
    path: "/address.Address/GetAddress",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AddressRequest) => Buffer.from(AddressRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => AddressRequest.decode(value),
...
export interface AddressServer extends UntypedServiceImplementation {
  getAllAddresses: handleUnaryCall<Empty, AddressBook>;
  getAddress: handleUnaryCall<AddressRequest, Person>;
}

export interface AddressClient extends Client {
  getAllAddresses(
    request: Empty,
    callback: (error: ServiceError | null, response: AddressBook) => void,
  ): ClientUnaryCall;
  getAllAddresses(
    request: Empty,
    metadata: Metadata,
...
export const AddressClient = makeGenericClientConstructor(AddressService, "address.Address") as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): AddressClient;
  service: typeof AddressService;
};
